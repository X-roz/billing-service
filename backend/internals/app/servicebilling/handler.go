...
func (h *handler) AddBilling(c echo.Context) error {
	...
	s := new(ServicePayload)
	c.Bind(s)
	err := h.service.AddServiceBilling(s)
	if err != nil {
...
func (h *handler) ServiceBillings(c echo.Context) error {
	...
	data, err := h.service.AllServiceBillingDetails(startdate, enddate)
	if err != nil {
